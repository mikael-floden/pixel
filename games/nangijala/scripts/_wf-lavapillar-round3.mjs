...
await page.fill("input", "wf-lp3-" + Math.floor(Math.random() * 1e5));
...
async function walkTo(colT, rowT, ms = 120000) {
...
// leg 1: due north to row 220.5 (near current col), then east along row 220.5
console.log("n1:", JSON.stringify(await walkTo(260.4, 220.5, 150000)));
console.log("e1:", JSON.stringify(await walkTo(262.7, 220.5, 120000)));
// leg 3: due south to beside-east
console.log("c:", JSON.stringify(await walkTo(262.6, 222.4, 90000)));
await snap("c3-beside-east");

console.log("n2:", JSON.stringify(await walkTo(262.6, 221.5, 60000)));
console.log("e:", JSON.stringify(await walkTo(261.6, 221.55, 60000)));
await snap("e3-behind-north");

console.log("w1:", JSON.stringify(await walkTo(260.35, 221.6, 90000)));
console.log("a2:", JSON.stringify(await walkTo(260.35, 222.6, 60000)));
await snap("a3-beside-west");
