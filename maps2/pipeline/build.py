...
def main():
    ...
    if args.name == "prop_demo":
        ...
        return
    if args.name == "house_demo":
        import housedemo
        housedemo.build(os.path.join(MAPS2, "worlds", "house_demo"))
        return
    ...
    if args.name == "the_island":
        ...
        return
    if args.name == "the_island2":
        import islandworld2
        islandworld2.build(os.path.join(MAPS2, "worlds", "the_island2"))
        return
