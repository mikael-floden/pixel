...
- **THE POOL'S VERTICAL TERM IS 0.6 PER LEVEL FOR EVERY LIGHT** (`LIGHT_DROP`;
  twin in `lightAt`). A torch on the bridge pools on the river four levels
  down and the slab throws its shadow band across that pool — the shadow he
  loves. REJECTED (2026-09-18, one morning): a ramp to 1.2 per level from two
  levels below the light, meant to kill "a bright spot in the middle of the
  shadow the TORCH cast" (281.9,246.0 at Night). It killed the whole pool,
