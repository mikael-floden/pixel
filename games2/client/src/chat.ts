...
function injectStyles() {
  ...
  .ml-chatlog{position:fixed;left:46px;bottom:calc(var(--hud-h, 0px) + 46px);z-index:5;max-width:330px;
  ...
  .ml-chatinput{position:fixed;left:46px;bottom:calc(var(--hud-h, 0px) + 12px);z-index:6;width:320px;
