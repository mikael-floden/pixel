...
| [`shaders/`](shaders/) | Every spell, attack, item and monster effect — GLSL shaders whose look grows with a level 1-10, a runtime the game imports and a review viewer the wiki embeds | [`shaders/README.md`](shaders/README.md) |
